    ...
    <div class="container mx-auto p-8">
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mt-8 flex justify-end">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4 no-print" onclick="window.print()">Imprimer</button>
                <a href="#" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded no-print" download="lettre_reclamation_notes_etudiants.html">Télécharger</a>
            </div>
        </div>
    </div>
</body>
