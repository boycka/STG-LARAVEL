                    ...
                    <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                        <div class="sm:flex items-center justify-between">
                            <div class="flex items-center">
                                <a class="rounded-full focus:outline-none focus:ring-2  focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8" href="{{url('Etudiant/Rclamer')}}">
                                    <div class="py-2 px-8 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full">
                                        <p>Recemment</p>
                                    </div>
                                </a>
                                <a class="rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8" href="{{url('Etud/Acc')}}">
                                    <div class=" py-2 px-8 bg-indigo-100 text-indigo-700 rounded-full ">
                                        <p>Accepte</p>
                                    </div>
                                </a>
                                <a class="rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800 ml-4 sm:ml-8" href="{{url('Etud/Reje')}}">
                                    <div class="py-2 px-8 text-gray-600 hover:text-indigo-700 hover:bg-indigo-100 rounded-full ">
                                        <p>Rejeter</p>
                                    </div>
                                </a>
                                    ...
                                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                        ...
                                        <td class="">
                                            <div class="flex items-center pl-5">
                                                <p class="text-base font-medium leading-none text-gray-700 mr-2">Prof Maurice</p>
                                            </div>
                                        </td>
                                        <td class="pl-24">
                                        ...
                                        <td class="pl-5">
                                            <button class="py-3 px-3 text-sm focus:outline-none leading-none text-green-700 bg-green-100 rounded">envoiyer le 06/03 </button>
                                        </td>
                                        <td class="pl-4">
