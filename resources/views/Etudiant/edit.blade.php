      ...
      <form>
        ...
        <div class="flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4">
            ...
            <a href="{{url('Etudiant/text')}}" class="bg-pink-500 items-end text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
