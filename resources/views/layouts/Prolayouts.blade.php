...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="{{ url('/Professeur') }}" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">LOGO</a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            <a href="{{ url('/Professeur') }}" class="flex items-center opacity-75 hover:opacity-100 text-white py-4 pl-6 nav-item">
