...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="{{ url('/Admin') }}" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">{{ config('app.name', 'Admin') }}</a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            <a href="{{ url('/Admin') }}" class="flex items-center opacity-75 hover:opacity-100 text-white py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            <div class="flex items-center justify-between">
                <a href="{{ url('/Admin') }}" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">Admin</a>
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                <a href="{{ url('/Admin') }}" class="flex items-center opacity-75 hover:opacity-100 text-white py-2 pl-4 nav-item">
                ...
                <button class="w-full bg-white cta-btn font-semibold py-2 mt-3 rounded-lg shadow-lg hover:shadow-xl hover:bg-gray-300 flex items-center justify-center">
                    <i class="fas fa-arrow-circle-up mr-3"></i> OFPPPPTTTT
                </button>
            </nav>
